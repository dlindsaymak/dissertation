...
[**N**]{.underline} = `r paste(n)`

Mean [**Age**]{.underline} = `r paste(m_age)`(`r paste(sd_age)`)

Mean [**SES**]{.underline} = `r paste(m_ses)`(`r paste(sd_ses)`)\
*Scored on a 10 point ladder with 10 being the best off, and 1 being the worst off*

Mean [**Political Ideology**]{.underline} = `r paste(m_pol)`(`r paste(sd_pol)`)\
