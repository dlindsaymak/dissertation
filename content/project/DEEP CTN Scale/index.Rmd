...
An Analysis of Variance comparing the model fit of the four factor
structures showed that there was 
1. the reduced four-factor model provided a slightly better fit (Chi-sq= `r x2_3`(`r df_3`), p = `r p_3`).

2. the reduced multi-dimensional models had significantly improved fit
compared to the reduced unidimensional model (Chi-sq = `r x2_4`(`r df_4`), p =
`r p_4`).
...
```{r individual wb measures correlations, echo=FALSE}
#reversed
...
```{r Vitality predictive, echo=FALSE}
